...
/**
 * A comparator that compares two font faces A and B as follows: - A and B are
 * equal when (1) they have the exact same font size, and (2) they are equally
 * emphasized (e.g., both have italic and/or bold fonts). - A is larger than B
 * when (1) the font size of A is larger than the fontsize of B. (2) A is more
 * emphasized than B (where normal < italic < bold).
 *

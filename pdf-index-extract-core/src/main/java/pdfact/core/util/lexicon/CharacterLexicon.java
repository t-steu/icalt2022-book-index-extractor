...
public class CharacterLexicon {
     ...
     * @return True, if the given character is a letter or a digit; False otherwise.
     */
    ...
    public static boolean isPunctuationMark(Character character) {
        char ch = toChar(character);
        return BASELINE_PUNCTUATION_MARKS.contains(ch) || MEANLINE_PUNCTUATION_MARKS.contains(ch);
    }

    /**
     * Returns true if the given character is a terminating punctuation mark (= a
     * punctuation mark that terminates a sentence).
     *
     * @param character The character to process.
     * @return True if the given character is a terminating punctuation mark; false
     * otherwise.
     */
    ...
    /**
     * Returns true if the given character is a punctuation mark that is aligned to
     * the mean line.
     *
     * @param character The character to process.
     * @return True if the given character is a punctuation mark aligned to the mean
     ...
     *
     * @param character The character to process.
     * @return True if the given character is a punctuation mark aligned to the base
     * line; false otherwise.
     */
    ...
    public static boolean isAscender(Character character) {
        char ch = toChar(character);
        return java.lang.Character.isUpperCase(ch) || java.lang.Character.isDigit(ch) || ASCENDERS.contains(ch);
    }

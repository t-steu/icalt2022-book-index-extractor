...
public class WordNormalizer {
    ...
    protected boolean hasLeadingCharactersToKeep() {
        return this.leadingCharactersToKeep != null && !this.leadingCharactersToKeep.isEmpty();
    }
    ...
    protected boolean hasTrailingCharactersToKeep() {
        return this.trailingCharactersToKeep != null && !this.trailingCharactersToKeep.isEmpty();
    }
}

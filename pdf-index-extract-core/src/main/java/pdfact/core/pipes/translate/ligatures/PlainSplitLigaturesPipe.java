...
public class PlainSplitLigaturesPipe implements SplitLigaturesPipe {
    ...
    /**
     * Checks if the given character is a ligature and if so, translates it into its
     * individual characters and changes the textual content of the given character
     * accordingly. Does nothing if the character is not a ligature.
     *
     * @param character The PDF character to process.
     */
     ...
     *
     * @param character The PDF character to check.

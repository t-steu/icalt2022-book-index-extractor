...
public class PlainMergeDiacriticsPipe implements MergeDiacriticsPipe {
    ...
    /**
     * Chooses the belonging base character (either the given character to the left
     * or the given character to the right of the diacritic) and merges the given
     * diacritic with this base character.
     *
    ...
    public static boolean isDiacritic(Character character) {
        ...
        return type == java.lang.Character.NON_SPACING_MARK || type == java.lang.Character.MODIFIER_SYMBOL

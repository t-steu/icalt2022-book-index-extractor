...
public class PlainTokenizeToParagraphsPipe implements TokenizeToParagraphsPipe {
     ...
     *
     * @param blocks The blocks of the paragraph to process.
     ...
     * @param paraBlocks The paragraph to process.
    ...
    protected boolean belongsToParagraph(TextBlock block, List<TextBlock> paraBlocks) {
        ...
        // The block belongs to the paragraph, if the paragraph doesn't end with a
        // terminating
        // punctuation mark.

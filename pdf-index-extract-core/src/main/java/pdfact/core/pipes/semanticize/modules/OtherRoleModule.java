...
/**
 * A module that identifies the role "OTHER" to all text blocks to which no
 * semantic role was assigned yet.
 *
        ...
        for (Page page : pages) {
            ...
            for (TextBlock block : page.getTextBlocks()) {
                ...
                if (this.fontFaceComparator.compare(pdfFontFace, blockFontFace) < 0) {
                    ...
                    // The font face of the block is "larger" than the most common font face in the
                    // document.

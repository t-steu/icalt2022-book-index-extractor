...
public class PdfBoxAFMUtils {
     ...
     */
    protected static final Map<String, PdfBoxFontMetricsWrapper> ADDITIONAL_AFM = readAdditionalAFMFiles("afm/");
     ...
     */
    protected static Map<String, PdfBoxFontMetricsWrapper> readAdditionalAFMFiles(String path) {

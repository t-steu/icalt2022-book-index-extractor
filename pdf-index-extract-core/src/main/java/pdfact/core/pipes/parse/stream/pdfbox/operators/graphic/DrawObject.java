...
public class DrawObject extends OperatorProcessor {
    ...
    public void process(Document pdf, Page page, Operator op, List<COSBase> args) throws IOException {
        ...
        // Primarily, we handled a form object *always* as a figure. But that's wrong,
        // because a form
        // can contain text (in a substream) which appears as "normal" body text in a
        // PDF, see
        ...
        // Matrix ctm =
        // this.engine.getGraphicsState().getCurrentTransformationMatrix().clone();

...
import static pdfact.core.PdfActCoreSettings.*;
...
public class PDFontConverter {
    ...
    /**
     * Computes the normalized name of the given font, that is the lower cased font
     * name without the prefix (the part before "+"). For example, the normalized
     * name of "LTSLOS+NimbusSanL-Bold" is "nimbussanl-bold".
     *
     * @param font The font to process.
    ...
    /**
     * Computes the basename of the given font, that is the normalized name without
     * the part after the "-" symbol. For example, the basename of

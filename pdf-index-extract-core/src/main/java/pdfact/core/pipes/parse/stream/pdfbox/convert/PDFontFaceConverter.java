...
public class PDFontFaceConverter {
    ...
    /**
     * Returns a {@link FontFace} object related to the given font and font size if
     * the font face is already known; null otherwise.
     *
     * @param font     The font to process.
     * @param fontSize The font size to process.
     * @return A {@link FontFace} object related to the given font and font size if
     * the font is already known; null otherwise.
     */

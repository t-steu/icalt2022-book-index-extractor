...
public class PdfAct {
    ...
    /**
     * The semantic roles of the text units to extract (e.g., "title", "author",
     * etc.).
     */
    protected Set<SemanticRole> semanticRoles;

    /**
     * A boolean flag indicating whether or not to print debug info about the PDF
     * parsing step.
     */
    protected boolean isDebugPdfParsing;

    /**
     * A boolean flag indicating whether or not to print debug info about the
     * extracted characters.
     */
    protected boolean isDebugCharacterExtraction;

    /**
     * A boolean flag indicating whether or not to print debug info about splitting
     * ligatures.
     */
    protected boolean isDebugSplittingLigatures;

    /**
     * A boolean flag indicating whether or not to print debug info about merging
     * diacritics.
     */
    protected boolean isDebugMergingDiacritics;

    /**
     * A boolean flag indicating whether or not to print debug info about the text
     * line detection.
     */
    ...
    /**
     * The destinartion path for the index extraction.
     */
    protected Path indexExtractionPath;

    /**
     * A boolean flag indicating whether or not to insert certain control characters
     * into the TXT serialization output, for example: (1) the character "^L" ("form
     * feed"), representing a page break between two PDF elements; or (2) the
     * character "^A" ("start of heading"), identifying the headings of a document.
     */
    ...
    public Document parse(Path pdfPath) throws PdfActException {
        ...
        if (this.indexExtractionPath != null) {
            service.setIndexExtractionPath(this.indexExtractionPath);
        }
    ...
    /**
     * Returns true if debug info about the PDF parsing step should be printed,
     * false otherwise.
     */
    ...
    /**
     * Returns true if debug info about the character extraction step should be
    ...
    /**
     * Sets whether or not debug info about the characters extraction step should be
     * printed.
     */
    ...
    /**
     * Returns true if debug info about the splitting ligatures step should be
     * printed, false otherwise.
     */
    ...
    /**
     * Sets whether or not debug info about the splitting ligatures step should be
     * printed.
     */
    ...
    /**
     * Returns true if debug info about the merging diacritics step should be
     * printed, false otherwise.
     */
    ...
    /**
     * Sets whether or not debug info about the merging diacritics step should be
     * printed.
     */
    ...
    /**
     * Returns true if debug info about the text line detection step should be
     * printed, false otherwise.
     */
    ...
    /**
     * Sets whether or not debug info about the text line detection step should be
     * printed.
     */
    ...
    /**
     * Returns true if debug info about the word detection step should be printed,
     * false otherwise.
     */
    ...
    /**
     * Sets whether or not debug info about the word detection step should be
     * printed.
     */
    ...
    /**
     * Returns true if debug info about the block detection step should be printed,
     * false otherwise.
     */
    ...
    /**
     * Sets whether or not debug info about the block detection step should be
     * printed.
     */
    ...
    /**
     * Returns true if debug info about the roles detection step should be printed,
     * false otherwise.
     */
    ...
    /**
     * Sets whether or not debug info about the roles detection step should be
     * printed.
     */
    ...
    /**
     * Returns true if debug info about the paragraphs detection step should be
     * printed, false otherwise.
     */
    ...
    /**
     * Sets whether or not debug info about the paragraphs detection step should be
     * printed.
     */
    ...
    /**
     * Returns true if debug info about the word dehyphenation step should be
     * printed, false otherwise.
     */
    ...
    /**
     * Sets whether or not debug info about the word dehyphenation step should be
     * printed.
     */
    ...
    /**
     * Returns true if index will be extracted, false otherwise.
     */
    public Path getIndexExtractionPath() {
        return indexExtractionPath;
    }

    /**
     * Sets whether or not the index should be extracted.
     */
    ...
    /**
     * Returns the path to the file to which the serialization output should be
     * written.
     */
    ...
    /**
     * Sets the path to the file to which the serialization output should be
     * written.
     */
    ...
    /**
     * Returns the boolean flag indicating whether or not to insert certain control
     * characters into the TXT serialization output, for example: (1) the character
     * "^L" ("form feed"), representing a page break between two PDF elements; or
     * (2) the character "^A" ("start of heading"), identifying the headings of a
     * document.
     */
    ...
    /**
     * Sets the boolean flag indicating whether or not to insert certain control
     * characters into the TXT serialization output, for example: (1) the character
     * "^L" ("form feed"), representing a page break between two PDF elements; or
     * (2) the character "^A" ("start of heading"), identifying the headings of a
     * document.

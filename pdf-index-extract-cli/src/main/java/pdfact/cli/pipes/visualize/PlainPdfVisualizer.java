...
public class PlainPdfVisualizer implements PdfVisualizer {
     ...
     */
    protected void visualizeCharacters(Document pdf, PdfDrawer drawer) throws PdfActVisualizeException {
     ...
     * @throws PdfActVisualizeException If the drawing failed.
     */
    protected void visualizeTextAreas(Document pdf, PdfDrawer drawer) throws PdfActVisualizeException {
     ...
     * @throws PdfActVisualizeException If the drawing failed.
     */
    protected void visualizeTextLines(Document pdf, PdfDrawer drawer) throws PdfActVisualizeException {
        for (Page page : pdf.getPages()) {
    ...
    protected void visualizeTextLine(TextLine textLine, PdfDrawer drawer) throws PdfActVisualizeException {
        ...
        // textLine.getPosition().getRectangle());
     ...
     * @throws PdfActVisualizeException If the drawing failed.
     */
    protected void visualizeTextBlocks(Document pdf, PdfDrawer drawer) throws PdfActVisualizeException {
        for (Page page : pdf.getPages()) {
     ...
     * @throws PdfActVisualizeException If the drawing failed.
     */
    protected void visualizeParagraphs(Document pdf, PdfDrawer drawer) throws PdfActVisualizeException {
        // Visualize the textual elements.
        for (Paragraph paragraph : pdf.getParagraphs()) {
            // Ignore the paragraph if its role should not be extracted.
            if (!hasRelevantRole(paragraph)) {
    ...
    protected void visualizePositions(PdfDrawer drawer, Color color, Element elem, List<Position> positions)
        ...
        for (int i = 0; i < positions.size(); i++) {
            ...
            // try {
            // drawer.drawText("[" + i + "]", page, new Point(rect.getMaxX() + 5,
            // rect.getMinY()), color);
            // } catch (IOException e) {

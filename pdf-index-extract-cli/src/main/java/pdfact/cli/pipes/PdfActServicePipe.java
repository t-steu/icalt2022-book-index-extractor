...
public interface PdfActServicePipe extends Pipe {
     ...
     */
    void setInsertControlCharacters(boolean withControlCharacters);

    // ==============================================================================================

    /**
     * set the path fro the index extraction
     *
     * @return the path to the output xml
     */
    Path getIndexExctractionPath();

    /**
     * set the path fro the index extraction
     *
     * @param indexExtractionPath the path to the output xml
     */
    void setIndexExtractionPath(Path indexExtractionPath);
}

...
public class PdfTxtSerializer implements PdfSerializer {
    /**
     * The control character to optionally insert when a page break occurs in the
     * PDF.
     */
    ...
    /**
     * The default boolean flag indicating whether or not this serializer should
     ...
     *
     * @param withControlCharacters Whether or not control characters should be
     *                              inserted.
     */
            ...
            for (Paragraph paragraph : pdf.getParagraphs()) {
                ...
                if (paragraphStr != null) {
                    ...
                    if (withControlCharacters) {
                        ...
                        // Check if we have to insert the control character that identifies a page
                        // break.
                ...
                // Keep track of the position of this element, for deciding if a page break
                // occured between

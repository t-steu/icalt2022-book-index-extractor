...
public class PlainSerializePdfPipe implements SerializePdfPipe {
     ...
     * @throws PdfActException If something went wrong while serializing the PDF
     *                         document.
     */
    protected void serialize(Document pdf) throws PdfActException {
        ...
        switch (this.format) {
            ...
            case TXT:
                ...
                break;
            default:
                throw new PdfActSerializeException("Couldn't find a serializer for the format '" + this.format + "'.");
        }
     ...
     * @throws PdfActSerializeException If something went wrong while writing the
     *                                  bytes to the stream.
     */

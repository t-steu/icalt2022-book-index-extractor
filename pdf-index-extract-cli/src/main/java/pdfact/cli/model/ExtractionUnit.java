...
public enum ExtractionUnit {
     ...
     * Creates a new unit.
     *
     * @param pluralName The plural name of this unit.
     */
    ExtractionUnit(String pluralName) {
     ...
     *
     * @param names The names of the units to fetch.
     ...
     *
     * @param name The plural name of the type to fetch.
